...
<link rel="icon" type="image/x-icon" href="img\favicon.ico.jpg">
        <title>Cake Studio || Cake Details</title>
        ...
        <section class="our_cakes_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Our Cakes</h2>
        			<h5>The best customized cake with different flavour and different categories....</h5>
        		</div>
...
<?php }?>
    ...
    <a <?php if($page_no > 1){ echo "href='?page_no=$previous_page'"; } ?>>Previous &nbsp </a>
    </li>
    ...
    if($page_no <= 4) {         
     ...
     elseif($page_no > 4 && $page_no < $total_no_of_pages - 4) {         
        echo "<li><a href='?page_no=1'>1 &nbsp</a></li>";
        echo "<li><a href='?page_no=2'>2 &nbsp</a></li>";
        echo "<li><a>...</a></li>";
...
?>
    ...
    <a <?php if($page_no < $total_no_of_pages) { echo "href='?page_no=$next_page'"; } ?>>&nbsp Next</a>
    </li>
